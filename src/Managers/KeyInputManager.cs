...
public class KeyInputManager : MonoBehaviour
{
	...
	private static readonly Dictionary<KeyCode, Action> OnDown = new();
	private static readonly Dictionary<KeyCode, Action> OnUp = new();
	private static readonly Dictionary<KeyCode, Action> OnHeld = new();

	private static readonly Dictionary<int, Action> MouseDown = new();
	private static readonly Dictionary<int, Action> MouseUp = new();
	private static readonly Dictionary<int, Action> MouseHeld = new();
	private static readonly HashSet<int> RegisteredMouseButtons = new();

	private static readonly HashSet<KeyCode> RegisteredKeys = new();

	public static KeyEventAccessor OnKeyDown { get; } = new(OnDown);
	public static KeyEventAccessor OnKeyUp { get; } = new(OnUp);
	public static KeyEventAccessor OnKeyHeld { get; } = new(OnHeld);

	public static MouseEventAccessor OnMouseDown { get; } = new(MouseDown);
	public static MouseEventAccessor OnMouseUp { get; } = new(MouseUp);
	public static MouseEventAccessor OnMouseHeld { get; } = new(MouseHeld);
	...
	private void Update()
	{
		if (RegisteredKeys.Count != 0)
		{
			...
			List<KeyCode> keysSnapshot = new(RegisteredKeys);
		...
		{
			List<int> mouseSnapshot = new(RegisteredMouseButtons);
	...
	public static void EnsureExists()
	{
		...
		GameObject go = new(nameof(KeyInputManager));
